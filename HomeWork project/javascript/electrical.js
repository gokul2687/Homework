// electrical service
    ...
    document.addEventListener('DOMContentLoaded',function(){
        ...
        var electricalform = document.getElementById('electricalform')
...
function electricalService()
{
    ...
    var electrical = document.getElementById('electricalopt').value.trim();
    ...
    if(electrical === '' )
    {
        setError(document.getElementById('electricalopt'),'This field is required')
    }
    else
    {
        setSuccess(document.getElementById('electricalopt'));
    }
}

function electricalbooknow()
{
    var name = document.getElementById('name').value.trim();
    var number = document.getElementById('number').value.trim();
    var email = document.getElementById('email').value.trim();
    ...
    if(name !== '' && number !=='' && email !=='' && location !== '' && pincode !== '' && address !== '' && date !=='' && time !=='' && electrical !=='')
    {
...
function setError(element, message) {
    ...
    var errorElement = inputGroup.querySelector('.electricalerror');
